...
async def register_plumber(plumber: PlumberRegistration):
    ...
    try:
        ...
        payment_service.attach_payment_method(
            ...
            payment_method=plumber.paymentMethodId
        )
        ...
        if db:
            try:
                plumber_data = {
                    'id': plumber_id,
                    'business_name': plumber.businessName,
                    'full_name': plumber.fullName,
                    'email': plumber.email,
                    'phone': plumber.phone,
                    'postcode': plumber.postcode,
                    'areas_served': plumber.areasServed or f"{plumber.postcode} area",
                    'years_experience': plumber.yearsExperience or 0,
                    'gas_safe_number': plumber.gasSafeNumber,
                    'stripe_customer_id': stripe_customer['id'],
                    'stripe_payment_method_id': plumber.paymentMethodId,

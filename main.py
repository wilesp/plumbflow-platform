"""
PlumberFlow Platform - Main Application
...
async def health_check():
    ...
    Just confirms the app is running - no external API calls
    """
    
    # Check if pricing engine initialized (don't call it!)
    pricing_status = "ok" if pricing_engine is not None else "not initialized"

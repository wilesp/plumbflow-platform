...
async def tradesperson_register():
    """Serve tradesperson registration page"""
...
async def tradesperson_dashboard():
    """Serve tradesperson dashboard page"""
...
async def job_submitted():
    """Serve job submitted confirmation page"""

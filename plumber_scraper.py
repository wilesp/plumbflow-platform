"""
PLUMBERFLOW - COMPLETE HOME COUNTIES SCRAPER v2.1 FINAL
Google Maps API + Manual Yell Import
222 postcodes: London + Herts + Beds + Bucks + Essex + Kent + Oxon + Northants
...
# SAFETY LIMITS
MAX_POSTCODES_PER_RUN = 250
COST_PER_POSTCODE = 0.20
MAX_COST_PER_RUN = 50.00

# COMPLETE HOME COUNTIES - 222 POSTCODES
POSTCODES = [
    # ===== LONDON (148 postcodes) =====
    ...
    'AL1','AL2','AL3','AL4','AL5','AL7','AL8','AL9','AL10',
    'SG1','SG2','SG4','SG5','SG6',
    'WD3','WD4','WD5','WD6','WD17','WD18','WD19','WD23',
    ...
    'ME14','ME15','ME16','ME17',
    'TN1','TN2','TN4','TN9','TN13','TN14','TN15',
    'DA9','DA10',
        ...
        try:
            ...
            with self.conn.cursor() as cur:
                cur.execute("""
                    ...
                    (id, name, phone, email, address, postcode, postcode_area, website, source, rating, review_count)
                    VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
                    ON CONFLICT (id) DO NOTHING
                """, (plumber_id, name, phone, email, address, postcode, postcode_area, website, source, rating, reviews))
...
class PlumberScraper:
    ...
    def run(self, postcodes: List[str] = None, limit: int = None):
        ...
        Args:
            postcodes: List of postcodes or None for all 222
